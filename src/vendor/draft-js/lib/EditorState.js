...
var EditorState =
  ...
  (function() {
    ...
    EditorState.createWithContent = function createWithContent(
      contentState,
      decorator
    ) {
    ...
    EditorState.acceptSelection = function acceptSelection(
      editorState,
      selection
    ) {
    ...
    EditorState.forceSelection = function forceSelection(
      editorState,
      selection
    ) {
