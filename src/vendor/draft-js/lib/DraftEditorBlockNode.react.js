...
var getDraftRenderConfig = function getDraftRenderConfig(
  block,
  blockRenderMap
) {
  var configForType =
...
var getCustomRenderConfig = function getCustomRenderConfig(
  block,
  blockRendererFn
) {
  ...
  (function(_React$Component) {
    ...
    _proto.componentDidMount = function componentDidMount() {
      ...
      if (scrollParent === window) {
        ...
        !isHTMLElement(blockNode)
          ? process.env.NODE_ENV !== "production"
            ? invariant(false, "blockNode is not an HTMLElement")
            : invariant(false)
          : void 0;
    ...
    _proto.render = function render() {
      ...
      if (block.children.size) {
        children = block.children.reduce(function(acc, key) {
          ...
          var _getDraftRenderConfig = getDraftRenderConfig(
              child,
              blockRenderMap
            ),
