...
var AtomicBlockUtils = {
  insertAtomicBlock: function insertAtomicBlock(
    editorState,
    entityKey,
    character
  ) {
    ...
    var asAtomicBlock = DraftModifier.setBlockType(
      afterSplit,
      insertionTarget,
      "atomic"
    );
  ...
  moveAtomicBlock: function moveAtomicBlock(
    ...
    if (insertionMode === "before" || insertionMode === "after") {
      ...
      var _targetBlock = afterRemoval.getBlockForKey(
      ...
      if (selectionAfterRemoval.getStartOffset() === 0) {
        ...
        selectionAfterRemoval.getEndOffset() === _targetBlock.getLength()
      ) {
        withMovedAtomicBlock = moveBlockInContentState(
          afterRemoval,
          atomicBlock,
        ...
        var afterSplit = DraftModifier.splitBlock(
          afterRemoval,
          selectionAfterRemoval
        );
        var selectionAfterSplit = afterSplit.getSelectionAfter();

        var _targetBlock2 = afterSplit.getBlockForKey(
