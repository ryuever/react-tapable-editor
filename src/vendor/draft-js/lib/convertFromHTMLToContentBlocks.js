...
var knownListItemDepthClasses =
  ...
  _defineProperty(
    _knownListItemDepthCl,
    cx("public/DraftStyleDefault/depth0"),
    0
  ),
  _defineProperty(
    _knownListItemDepthCl,
    cx("public/DraftStyleDefault/depth1"),
    1
  ),
  _defineProperty(
    _knownListItemDepthCl,
    cx("public/DraftStyleDefault/depth2"),
    2
  ),
  _defineProperty(
    _knownListItemDepthCl,
    cx("public/DraftStyleDefault/depth3"),
    3
  ),
  _defineProperty(
    _knownListItemDepthCl,
    cx("public/DraftStyleDefault/depth4"),
    4
  ),
  _knownListItemDepthCl);
...
var ContentBlocksBuilder =
  ...
  (function() {
      ...
      for (var i = 0; i < nodes.length; i++) {
        ...
        if (nodeName === "body" || isListNode(nodeName)) {
          ...
          blockConfigs.push.apply(
            blockConfigs,
            this._toBlockConfigs(Array.from(node.childNodes))
          );
        ...
        if (blockType !== undefined) {
          ...
          if (
            ...
            var htmlElement = node;
            this.currentDepth = getListItemDepth(
              htmlElement,
              this.currentDepth
            );
          }
    ...
    _proto._appendText = function _appendText(text) {
      ...
      this.characterList = (_this$characterList = this
        .characterList).push.apply(
        _this$characterList,
    ...
    _proto._trimCurrentText = function _trimCurrentText() {
      ...
      entity = this.characterList
        .reverse()
        .findEntry(function(characterMetadata) {
          return characterMetadata.getEntity() !== null;
        });
    ...
    _proto._toContentBlocks = function _toContentBlocks(blockConfigs) {
      ...
      for (var i = 0; i <= l; i++) {
        ...
        this.contentBlocks.push(
          new ContentBlockNode(_objectSpread({}, config))
        );
    ...
    _proto._toFlatContentBlocks = function _toFlatContentBlocks(blockConfigs) {
      ...
      cleanConfigs.forEach(function(config) {
        var _this2$_extractTextFr = _this2._extractTextFromBlockConfigs(
            config.childConfigs
          ),
...
var convertFromHTMLToContentBlocks = function convertFromHTMLToContentBlocks(
  html
) {
  var DOMBuilder =
    arguments.length > 1 && arguments[1] !== undefined
