...
var updateBlockMapLinks = function updateBlockMapLinks(blockMap, newParentBlock, originalBlock, belowBlock) {
...
function CreateNestBlockPlugin() {
  this.apply = (getState) => {
    ...
    hooks.handleKeyCommand.tap('CreateNestBlockPlugin', (command, editorState) => {
