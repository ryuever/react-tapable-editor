...
const vitepressRequire = createRequire(
  createRequire(import.meta.url).resolve("vitepress/package.json"),
);
const vueAlias = vitepressRequire.resolve("vue");
const vueServerRendererAlias = vitepressRequire.resolve("vue/server-renderer");
...
export default withMermaid(
  defineConfig({
  title: "React Tapable Editor Wiki",
  description: "React Tapable Editor Wiki — 架构分析、技术讨论、参考手册与路线图",
  lang: "zh-CN",
  srcDir: "./codebase-wiki",
  vite: {
    resolve: {
      alias: [
        { find: /^vue$/, replacement: vueAlias },
        { find: /^vue\/server-renderer$/, replacement: vueServerRendererAlias },
      ],
    },
  },
  markdown: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: "React Tapable Editor Wiki",
    },
